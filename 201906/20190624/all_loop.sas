...
*%winsor(dsetin=testdata2, dsetout=testdata2, byvar=&wsby, vars=pe, type=&wstype, pctl=10 90);

%winsor(dsetin=testdata, dsetout=testdata2, byvar=globe, vars=&lhs, type=delete, pctl=1 99);
%winsor(dsetin=testdata2, dsetout=testdata2, byvar=country, vars=pvgo2, type=delete, pctl=5 95);
...
libname pwd "C:\TEMP\displace\20190621";
