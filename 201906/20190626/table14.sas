...
data pvgo2; set bk.new_pvgo_bk;
pvgo2=dec75-dec25;
keep country portyear pvgo2;
run;

data rhsdata; merge pvgo2 daily.short daily.irisk daily.dvol daily.snipo daily.pbsprd;
by country portyear;
dvol=log(coalesce(dvol_old, dvol_sum)/1000);
irisk=irisk*100;
snipo=snipo*100;
keep country portyear pvgo2 short irisk dvol snipo pbsprd;
run;
...
var &lhs pvgo2 short irisk dvol snipo pbsprd;
...
select country, mthyr, globe, &lhs-avg(&lhs) as &lhs, 
	pvgo2-avg(pvgo2) as pvgo2, short-avg(short) as short, 
...
%MYREG2DSE(&lhs, pvgo2 short, country, mthyr, 0, testdata6, myreg1);
%MYREG2DSE(&lhs, pvgo2 irisk, country, mthyr, 0, testdata6, myreg2);
%MYREG2DSE(&lhs, pvgo2 dvol, country, mthyr, 0, testdata6, myreg3);
%MYREG2DSE(&lhs, pvgo2 snipo, country, mthyr, 0, testdata6, myreg4);
%MYREG2DSE(&lhs, pvgo2 pbsprd, country, mthyr, 0, testdata6, myreg5);
%MYREG2DSE(&lhs, pvgo2 short irisk dvol snipo pbsprd, country, mthyr, 0, testdata6, myreg6);
...
model &lhs=pvgo2 short year:;
model &lhs=pvgo2 irisk year:;
model &lhs=pvgo2 dvol year:;
model &lhs=pvgo2 snipo year:;
model &lhs=pvgo2 pbsprd year:;
model &lhs=pvgo2 short irisk dvol snipo pbsprd year:;
quit;
