...
libname pwd "C:\TEMP\displace\20190603";
...
data pwd.k4_truncate_country_portyear; set k4_truncate_country_portyear;
if id>3000;
run;

data pwd.k4_winsor_country_portyear; set k4_winsor_country_portyear;
if id>3000;
run;

data out1; set k4_truncate_country_portyear;
if id>3230;
run;

data out2; set k4_winsor_country_portyear;
if id>3230;
run;


x cd "C:\TEMP\displace\20190603";
ods tagsets.tablesonlylatex file="out1.tex"  (notop nobot) stylesheet="sas.sty"(url="sas"); proc print data=out1; run; quit;
