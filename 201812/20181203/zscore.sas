...
z3=(r3-mu3)/sigma3;
z=mean(z1, z2, z3);
* zcoal=coalesce(z1, mean(z1,z3), mean(z1, z2, z3));
...
/*
x md "C:\TEMP\displace\20181210\z3";
x cd "C:\TEMP\displace\20181210\z3";
*/

%macro zscoretest(denominator);

x md "C:\TEMP\displace\20181210\&denominator";
x cd "C:\TEMP\displace\20181210\&denominator";
