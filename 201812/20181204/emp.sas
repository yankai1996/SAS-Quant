...
x md "C:\TEMP\displace\20181210\EMP";
x cd "C:\TEMP\displace\20181210\EMP";


%zscore(tem, country, portyear, EMP1, EMP2, EMP3);
%zeffect(zscore, ret_us, country, ew, country_ew);
%zeffect(zscore, ret_us, country, lagmv_us, country_vw);

%zscore(tem, region, portyear, EMP1, EMP2, EMP3);
%zeffect(zscore, ret_us, region, ew, region_ew);
%zeffect(zscore, ret_us, region, lagmv_us, region_vw);

%zscore(tem, world, portyear, EMP1, EMP2, EMP3);
