...
/*
x md "C:\TEMP\displace\20181207\RD";
x cd "C:\TEMP\displace\20181207\RD";
*/


%macro zscoretest(denominator);

x md "C:\TEMP\displace\20181207\&denominator";
x cd "C:\TEMP\displace\20181207\&denominator";
...
%macro zEMPtest();
x md "C:\TEMP\displace\20181207\EMP";
x cd "C:\TEMP\displace\20181207\EMP";

%zscore(zscore, country, portyear, EMP1, EMP2, EMP2, EMP);
%getz(zscore, country, portyear, zEMP);
%zeffect(zscore, ret_us, country, ew, country_ew);
%zeffect(zscore, ret_us, country, lagmv_us, country_vw);

%zscore(zscore, region, portyear, EMP1, EMP2, EMP2, EMP);
%getz(zscore, region, portyear, zEMP);
%zeffect(zscore, ret_us, region, ew, region_ew);
%zeffect(zscore, ret_us, region, lagmv_us, region_vw);

%zscore(zscore, world, portyear,  EMP1, EMP2, EMP2, EMP);
%getz(zscore, world, portyear, zEMP);
%zeffect(zscore, ret_us, world, ew, world_ew);
%zeffect(zscore, ret_us, world, lagmv_us, world_vw);
