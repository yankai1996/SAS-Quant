...
data prmonthly; set mois.prmonthly;
if month=6;
portyear = year - 1;
...
run;
%twowaysprd(agret, &nobs, 10000000, 5, 5, rhs, lagmv_us, ret_us, equal, world, world, portyear, summary521);
...
run;
%twowaysprd(agret, &nobs, 10000000, 5, 5, rhs, lagmv_us, ret_us, lagmv_us, world, world, portyear, summary522);
