...
data agret; set disp.agret_twoway; run;
...
/*
proc rank data=workable2 out=intx_compare groups=5;
var &rankvar1 &rankvar2;
by &neutral &timevar;
ranks rank_var1 rank_var2;
proc sort; by code &neutral &timevar;
run;
data intx_compare; set intx_compare;
if rank_var1=. then delete;
if rank_var2=. then delete;
run;
*/
