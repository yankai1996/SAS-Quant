...
\thispagestyle{fancy}\fancyhead[LO]{coalesce, z(RD/\RD), Yan Kai}
\fancyhead[RO]{Nov 30, 2018}

\newcommand{\code}{\texttt}
\newcommand*{\Commonpath}{20181130}

We use the $z$-score as the $rhs$ to do the one-way-sort. The $z$-score is based on three signals, each $z_i = z(signal_i) = z(RD_i / SL) $, where 
$$
\begin{aligned}
& RD_1 = RD_t \\
...
and
$$
z = coalesce(z_1, mean(z_1, z_3), mean(z_1, z_2, z_3))
$$
