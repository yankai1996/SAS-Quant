...
\thispagestyle{fancy}\fancyhead[LO]{z(RD/\RD), Yan Kai}
\fancyhead[RO]{Nov 30, 2018}

\newcommand{\code}{\texttt}
\newcommand*{\Commonpath}{20181130}

We use the $z$-score as the $rhs$ to do the one-way-sort. The $z$-score is based on three signals, each $signal_i = RD_i / SL $, where 
$$
\begin{aligned}
& RD_1 = RD_t \\
& RD_2 = RD_t + 0.8 RD_{t-1} + 0.6 RD_{t-2} + 0.4 RD_{t-3} + 0.2 RD_{t-4} \\
& RD_3 = RD_t + 0.8 RD_{t-1} + 0.6 RD_{t-2}
\end{aligned}
$$
