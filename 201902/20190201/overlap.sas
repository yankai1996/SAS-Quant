...
data new; set agret0 agret1_us agret1_xus;
keep code mthyr country;
run;

data old; set dsws.agret0;
keep code mthyr country;
run;
...
x cd "C:\TEMP";
ods tagsets.tablesonlylatex file="stat.tex"   (notop nobot) stylesheet="sas.sty"(url="sas"); proc print data=stat; run; quit;
