...
%winsor(dsetin=testdata, dsetout=testdata3, byvar=country, vars=pe, type=winsor, pctl=15 85);
data testdata3; set testdata3;
keep mthyr country pe;
proc sort; by mthyr country;
run;
%winsor(dsetin=testdata, dsetout=testdata4, byvar=globe, vars=short irisk dvol snipo pbsprd, type=winsor, pctl=1 99);
