...
%let pwd = "C:\TEMP\displace\20190723";
x md &pwd;
x cd &pwd;
libname pwd &pwd;
...
proc export data= table2
	outfile= "C:\TEMP\displace\20190712\table2.csv"
    dbms=csv replace;
run;
...
%twowaysprd(tem, 30, 10000000, 5, 5, lagmv_us, rhs, ret_us, equal, world, world, portyear, world_ew);
...
%twowaysprd(tem, 30, 10000000, 5, 5, lagmv_us, rhs, ret_us, lagmv_us, world, world, portyear, world_vw);
