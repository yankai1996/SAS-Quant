...
libname pwd "C:\TEMP\displace\20190711";
...
%hkkreg(pwd.g_ew_sprd, g_ew);
%hkkreg(pwd.g_vw_sprd, g_vw);
%hkkreg(pwd.cn_ew_sprd, cn_ew);
%hkkreg(pwd.cn_vw_sprd, cn_vw);
%hkkreg(pwd.cn_xus_ew_sprd, cn_xus_ew);
%hkkreg(pwd.cn_xus_vw_sprd, cn_xus_vw);
...
proc export data=table4
	outfile= "C:\TEMP\displace\20190711\table4.csv"
    dbms=csv replace;
run;
