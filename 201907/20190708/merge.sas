...
libname pwd "C:\TEMP\displace\20190704";

data merged2; merge permno(in=a) pwd.quarter2(in=b);
by gvkey;
if a and b;
proc sort; by permno;
run;
...
data pwd.merged2; set merged2;
if datadate~=.;
keep permno gvkey iid datadate FYEARQ FQTR ATQ CEQQ IBQ LTQ PSTKQ TXDIQ;
