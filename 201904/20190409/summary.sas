...
libname sprd "C:\TEMP\displace\20190403\&obs-obs\&type.1-&by";
*libname sprd "C:\TEMP\displace\201903\20190328\&obs-obs\&type.2.5-&by";
/*
%if &j=0 %then %do;
...
libname pwd "C:\TEMP\displace\20190408\4k-obs";
data pwd.summary_winsor1; set slope_summary; run; 
