...
%rhstest(irisk, &wstype, &wsby, &ij.1);
%rhstest(dvol, &wstype, &wsby, &ij.2);
%rhstest(short, &wstype, &wsby, &ij.3);
%rhstest(irisk dvol short, &wstype, &wsby, &ij.4);
...
%let root=C:\TEMP\displace\20190408;
