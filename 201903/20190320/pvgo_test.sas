...
libname dsktp "Z:\Users\kaiyan\Desktop";
data dsktp.meanretvw; set meanretvw;
by country year;
ret=vwmktret;
if vwmktret<=0 then ret=.;
ret2=ret;
keep country year ret ret2;
run;


proc import out=work.meanretvw2
	file="Y:\Desktop\meanretvw.csv" 
	dbms=csv replace;
getnames=yes;
run;

data meanretvw; set meanretvw2;
vwmktret=ret2;
keep country year vwmktret;
run;
