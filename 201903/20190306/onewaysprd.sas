...
%sprd(&input, 50, 100000, &ret, &sort, portyear, &weighting, 5, &z);

/*
%sprd(&input, 31, 50, &ret, &sort, portyear, &weighting, 3, &z);
%sprd(&input, 51, 1000000, &ret, &sort, portyear, &weighting, 5, &z);
*/
data sprd;
*set sprd3 sprd5 sprd10;
set sprd5;
