...
output out=pvgosprd p25=pvgolow1 pvgolow2 pvgolow3 pelow p75=pvgohigh1 pvgohigh2 pvgohigh3 pehigh;
run;

data pvgosprd; set pvgosprd;
pvgo1=pvgohigh1-pvgolow1;
pvgo2=pvgohigh2-pvgolow2;
pvgo3=pvgohigh3-pvgolow3;
pe=pehigh-pelow;
keep country portyear pvgo1 pvgo2 pvgo3 pe;
run;
...
data twoDsprd.pvgosprd; set pvgosprd; run;
