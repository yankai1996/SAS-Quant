...
proc sort data=agret0; by portyear; run;
...
*keep code country  mthyr portyear year ret ret_us MC RD EMP COG SGA p_us_updated p_us_10;
...
dm 'log;clear;';
%let pwd = "C:\TEMP\displace\20190227\lagcog_us-21-top33";
x md &pwd;
x cd &pwd;
libname pwd &pwd;
...
proc sort data=zscore; by mthyr;
...
if zEMP>=p67;
run;
%zRD(agret3, world, portyear, signal1, signal2, signal3, RD);
