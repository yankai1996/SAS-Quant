...
%winsor(dsetin=testdata, dsetout=testdata2, byvar=mthyr, vars=&rhs, type=delete, pctl=15 85);
...
%twoDtest(country_vw_sprd, retsprd, pvgo2, output1);
%twoDtest(country_ew_slope, slope, pvgo2, output1);
%twoDtest(country_vw_slope, slope, pvgo2, output1);
...
proc univariate data=testdata2;
var pvgo2;
run;
...
data junk2; set ag21;
if country="CN" and portyear=2003;
run;
proc univariate data=junk2; var pvgo2; run;

data junk3; set nnnDS.retm;
if DSCD=930952;
run;
