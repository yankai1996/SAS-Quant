...
proc import out=work.&data
	file="Y:\Desktop\sas-python\&data..csv" 
	dbms=csv replace;
getnames=yes;
run;
...
p_updated csh cm ta taus dvp ocf cl EPS;
