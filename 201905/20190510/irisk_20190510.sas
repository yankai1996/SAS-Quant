...
if price_lc=. & ri_lc=. & tdvol=. then delete;
proc sort; by dscd;
run;
...
proc means data=dvoly_xus noprint; by country portyear;
var dvoly;
output out=dvol_xus_ew mean=dvol_ew sum=dvol_sum;
run;
...
data dvol_xus; merge dvol_xus dvol_xus_ew MC_xus;
by country portyear;
dvol=dvol/MC_sum;
dvol_ew=dvol_ew/MC_sum;
dvol_sum=dvol_sum/MC_sum;
...
proc means data=dvoly_us noprint; by portyear;
var dvoly;
output out=dvol_us_ew mean=dvol_ew sum=dvol_sum;
run;
...
data dvol_us; merge dvol_us dvol_us_ew MC_us;
by portyear;
dvol=dvol/MC_sum;
dvol_ew=dvol_ew/MC_sum;
dvol_sum=dvol_sum/MC_sum;
