...
dm 'log;clear;';
%let pwd = "C:\TEMP\displace\20190110\RDaddCOG";
x md &pwd;
x cd &pwd;
libname pwd &pwd;
...
%zcombine(zscore, country, portyear, 1);
...
%zcombine(zscore, region, portyear, 1);
...
%zcombine(zscore, world, portyear, 1);
...
%macro saveTS(name);
data pwd.&name; set port2;
drop portnum2 _type_ _freq_;
run;
%mend;
...
dm 'log;clear;';
%let pwd = "C:\TEMP\displace\20190110\two-way\&EMPi";
x md &pwd;
x cd &pwd;
libname pwd &pwd;
