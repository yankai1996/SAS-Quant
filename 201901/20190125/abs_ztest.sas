...
dm 'log;clear;';
%let pwd = "C:\TEMP\displace\20190128\old\xUS-one-way-decile-201006";
x md &pwd;
x cd &pwd;
libname pwd &pwd;
...
%zEMP(zscore, country, portyear, EMP1, 1);
...
%zEMP(zscore, region, portyear, EMP1, 1);
...
%zEMP(zscore, world, portyear, EMP1, 1);
